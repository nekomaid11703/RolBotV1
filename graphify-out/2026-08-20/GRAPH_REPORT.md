# Graph Report - RolBotV1  (2026-08-20)

## Corpus Check
- 585 files · ~34,450,550 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5107 nodes · 7834 edges · 271 communities (241 shown, 30 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 370 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d82e1758`
...
5. `advanceTurn()` - 30 edges
6. `formatError()` - 30 edges
7. `formatDisplayMention()` - 30 edges
8. `filterExisting()` - 29 edges
9. `supabase` - 29 edges
10. `resolveTargetDisplayName()` - 29 edges
...
## Communities (271 total, 30 thin omitted)

### Community 0 - "bot.js"
Cohesion: 0.09
Nodes (35): cleanupSock(), { default: makeWASocket, DisconnectReason, fetchLatestBaileysVersion }, forceNewSession(), { getOwnerJids }, { getResolvedSince }, { loadCommands }, { logSystem, logError, cleanOldLogs }, P (+27 more)
...
Cohesion: 0.12
Nodes (29): chatCommandTails, checkAdminOnly(), checkAdminPerm(), checkBotAdminOnly(), checkCreatorOnly(), checkEconomyAdmin(), checkGroupOnly(), checkPermission() (+21 more)
...
Cohesion: 0.09
Nodes (40): { BLOCK_PREFER_DEF_THRESHOLD }, FAMILIES, MATERIAL_RARITY_ORDER, MATERIAL_RARITY_WEIGHTS, TIER_CAPS, {
  ARMOR_SLOTS,
  COVERAGES,
  NO_WEAPON_CHANCE,
  NO_PIECE_CHANCE,
...
Cohesion: 0.12
Nodes (23): buildDefaultProfile(), buildRegistration(), ensureUserProfile(), { filterExisting }, getTopActiveUsers(), listUserProfiles(), METADATA_UPDATERS, normalizeActivity() (+15 more)

### Community 14 - "unwarn.js"
Cohesion: 0.07
Nodes (39): { addParticipant }, { box }, execute(), { box }, execute(), { openGroup }, { box }, { closeGroup } (+31 more)
...
Cohesion: 0.07
Nodes (68): { box }, buildAttackGearLines(), { calcFatigueCost, capFatigue }, {
  executeAttack,
  executeReaction,
  chooseAiReaction,
  calculateXpReward,
...
}, { formatError }, { getActiveCharacter, addXp, setHp } (+60 more)
...
Cohesion: 0.09
Nodes (37): deriveWeapon(), buildLabWeapon(), buildLabFighter(), attachAmmo(), buildLabFighter(), buildLabWeapon(), { buildStressFighter }, EXPERIMENTS_DIR (+29 more)
...
Cohesion: 0.06
Nodes (52): { addMoney }, execute(), { executeEconomyAction }, { box }, execute(), { formatCommandUsage }, { formatDisplayMention }, { formatError } (+44 more)
...
Cohesion: 0.05
Nodes (70): execute(), { findSessionByUser, removeSession }, { formatCombatDisolved }, execute(), getRestContext(), execute(), { findSessionByCharacter, findSessionByUser }, { formatCombatStatus } (+62 more)
...
Cohesion: 0.07
Nodes (46): execute(), { executeGroupAction }, { removeParticipant }, { demoteFromAdmin }, execute(), { executeGroupAction }, execute(), { executeGroupAction } (+38 more)
...
Cohesion: 0.15
Nodes (9): hasColumn(), { cache, TTLS }, cachedRead(), groupCacheKey(), { hasColumn }, invalidateGroupCache(), safeSelect(), topBalancesCacheKey() (+1 more)
...
Cohesion: 0.10
Nodes (44): execute(), { box }, execute(), executeDeletion(), { formatCommandUsage }, { formatError }, { listCharacters, deleteCharacter }, pendingConfirmations (+36 more)
...
Cohesion: 0.12
Nodes (33): ARMOR_SLOTS, ARROW, COVERAGES, GENERATED_STATS, IRON_FAMILY, ITEM_POOL, SET_BONUS, STAT_CLAMP (+25 more)
...
Cohesion: 0.09
Nodes (42): applyReactionFatigue(), { BASE_ATTACK_RANGE, KITE_FATIGUE_MULTIPLIER }, {
  calcFatigueRecovery,
  calcFatigueCost,
  capFatigue,
  getFatigueLevel,
  ...
  getCastEfficiency,
  getMovementRange,
}, characterShape(), createDurability(), { executeAttack, executeReaction, chooseAiReaction, getEffectiveWeaponRange }, executeHalfTurn(), fatigueRatio() (+34 more)

### Community 96 - "combatBalance.js"
Cohesion: 0.12
Nodes (15): Deuda Técnica Registrada, TD-001 | Versionado de schema duplicado | resuelto (2026-08-03), TD-002 | Migraciones no aplicables por RPC `exec_sql` inexistente | resuelto (2026-08-03), TD-003 | Esquema conocido desincronizado | resuelto (2026-08-03), TD-004 | `exec_sql` con `security definer` no deseado | abierto, TD-005 | Equipo en contraataques y reacciones no resuelto | resuelto (2026-08-20), TD-006 | `itemCatalog` inyectable | resuelto parcialmente (2026-08-03), TD-007 | Arma arrojadiza no lanzable en combate real | abierto (+7 more)
...
Cohesion: 0.11
Nodes (28): applyArmorMode(), { applyFatiguePenalties }, applyMaterialAbsorption(), applyPenalties(), attemptBlock(), attemptDodge(), {
  BLOCK_PREFER_DEF_THRESHOLD,
  ARMOR_USE_BONUS_DEF_TO_DEF,
  ARMOR_SOAK_RATIO,
  ARMOR_OVERFLOW_TO_HP,
}, calculateDamage() (+20 more)
...
Cohesion: 0.06
Nodes (38): { box }, { formatCommandUsage }, { formatError }, { isAdmin }, { MAX_CHARACTER_NAME_LENGTH }, { renameCharacter, updateCharacterSlots, getActiveCharacter }, usageMessage, { box } (+30 more)
...
Cohesion: 0.05
Nodes (67): execute(), execute(), { box }, CATEGORIES, CATEGORY_DISPLAY, execute(), { formatCommandUsage }, { formatDisplayMention, withMentions } (+59 more)
...
Cohesion: 0.25
Nodes (10): { buildSpellDefinition }, deleteUserSpellRecipe(), fs, itemCatalog, loadUserSpells(), path, readUserSpellRecipes(), registerSpellRecipe() (+2 more)
...
Cohesion: 0.07
Nodes (28): main(), say(), { supabase }, TEMP_PREFIXES, KNOWN_SCHEMA, { logSystem }, { supabase }, checkHealth() (+20 more)
...
Cohesion: 0.12
Nodes (28): ACTIVATIONS, CHANNEL_BY_NATURE, EFFECT_TARGETS, EFFECT_TYPES, EFFECT_WEIGHTS, FATIGUE_SPEED_STATS, FATIGUE_THRESHOLDS, MOMENTS (+20 more)
...
### Community 205 - "Stress Test — Fase A (full)"
Cohesion: 0.50
Nodes (3): Invariantes, Resultados por par (winrate A), Stress Test — Fase A (full)

### Community 206 - "Stress Test — Fase A (full)"
Cohesion: 0.50
Nodes (3): Invariantes, Resultados por par (winrate A), Stress Test — Fase A (full)

### Community 207 - "Stress Test — Fase A (weapon)"
Cohesion: 0.50
...
Cohesion: 0.09
Nodes (27): { calculateMovementFatigue }, countSetPieces(), COVERAGE_RULES, getCoverage(), getMovementFatigueWithCoverage(), resolveSetBonuses(), { ARMOR_SETS }, buildEntriesFromDummy() (+19 more)
...
Cohesion: 0.11
Nodes (14): FULGOR_NATURES, SPELL_APPLICATIONS, buildSpellDefinition(), deriveDamageNature(), fingerprintSpell(), normalizeResolution(), refineSpell(), validateSpellRecipe() (+6 more)
...
Cohesion: 0.08
Nodes (41): armorLine(), fighterSection(), { generateFighter }, { getSpecialTierMult }, main(), materialLine(), { materialName }, { MATERIALS, getMaterialStats } (+33 more)
...
### Community 261 - "itemFactory.js"
Cohesion: 0.07
Nodes (33): ARCANE_GEAR, ARCANE_SPELLS, { buildSpellDefinition }, { createItemDefinition }, define(), itemCatalog, ARMOR_SETS, getSet() (+25 more)

### Community 262 - "combatMessages.js"
Cohesion: 0.31
...
### Community 266 - "createReport"
Cohesion: 0.31
Nodes (8): MAGIC_STATS, PERSONALITIES, formatMarkdownReport(), num(), passFail(), pct(), { PERSONALITIES, FATIGUE_SNAPSHOT_TURNS, PHYSICAL_STATS, MAGIC_STATS, MAX_ROUNDS }, PERSONALITY_KEYS

### Community 267 - "dummy_arcane.test.js"
Cohesion: 0.08
Nodes (32): generateDummyCharacter(), ARCANE_DUMMY_LOADOUT, buildDummyEquipment(), { getItem }, IRON_DUMMY_LOADOUT, { buildDummyEquipment, ARCANE_DUMMY_LOADOUT }, CHALLENGER_STATS, { executeAttack } (+24 more)

### Community 268 - "durabilityPersistenceService.js"
Cohesion: 0.13
Nodes (14): _applyDurabilityHit(), { box }, { calcFatigueCost, calcFatigueRecovery, capFatigue }, { executeReaction, calculateXpReward }, {
  findSessionByCharacter,
  advanceTurn,
  endSession,
  getEffectKoOutcome,
}, { formatActionMenu, buildFatigueBar }, { getActiveCharacter, addXp, setHp }, { persistArmorDurability } (+6 more)

### Community 269 - "bloquear.js"
Cohesion: 0.38
Nodes (6): { box }, execute(), { formatError }, { getReport, getUserReports }, getReport(), getUserReports()

## Knowledge Gaps
- **3346 isolated node(s):** `husky.sh script`, `$schema`, `src/core/bot.js`, `src/commands/**/*.js`, `src/data/**/*.js` (+3341 more)
...
- **Why does `box()` connect `unwarn.js` to `listCharacters`, `characterService.js`, `economyAdminHelper.js`, `box`, `composeMessage`, `durabilityPersistenceService.js`, `bloquear.js`, `characterSections.js`, `box`, `resolveTargetDisplayName`, `editar_pj.js`, `dado.js`, `inventario.js`, `moduleRegistry.js`, `grupo_cerrar.js`, `invite.js`, `item_add.js`, `inventory_service.test.js`, `admin_perm_list.js`, `items.js`, `runSimulation`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `supabase` connect `supabase.js` to `bot.js`, `bugReportService.js`, `inventario.js`, `Entity`, `iron_family.test.js`, `grupo_cerrar.js`, `logSystem`, `inventoryService.js`, `columnRegistry.js`, `combatMessages.js`, `inventory_service.test.js`, `durabilityPersistenceService.js`, `getUserProfile`, `Plan: Implementacion de Stats Magicas + Correcciones`, `economyService.js`, `characterSections.js`, `items.js`, `box`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `logError()` connect `inventoryService.js` to `bot.js`, `bugReportService.js`, `inventario.js`, `loggerService.js`, `renombrar_pj.js`, `grupo_cerrar.js`, `logSystem`, `invite.js`, `actividad.js`, `combatMessages.js`, `supabase.js`, `box`, `resolveTargetDisplayName`?**
