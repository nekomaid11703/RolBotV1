...
## Corpus Check
- 187 files · ~2,342,613 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1412 nodes · 3231 edges · 86 communities (62 shown, 24 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 259 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `22652bee`
...
- `simulateBattle()` --calls--> `executeReaction()`  [EXTRACTED]
  scripts/simulate_battles.js → src/services/rpg/combatEngine.js
- `simulateBattle()` --calls--> `capFatigue()`  [EXTRACTED]
...
Cohesion: 0.15
Nodes (30): execute(), calculateLevel(), DEFAULT_CHARACTER_SLOTS, DEFAULT_CHARACTER_STATS, LEVELABLE_STATS, RACES, RANGOS, xpForNextLevel() (+22 more)
...
Cohesion: 0.16
Nodes (19): { applyFatiguePenalties }, applyPenalties(), attemptBlock(), attemptDodge(), calculateDamage(), canReact(), chooseAiReaction(), { DAMAGE_MIN, BLOCK_REDUCTION } (+11 more)

### Community 15 - "economyService.js"
Cohesion: 0.14
Nodes (24): { addMoney }, execute(), { executeEconomyAction }, execute(), { executeEconomyAction }, { setMoney }, addMoney(), claimDaily() (+16 more)

### Community 16 - "test_helpers.js"
Cohesion: 0.17
Nodes (21): handlePvPWithReaction(), { box }, { calcFatigueCost, capFatigue }, execute(), {
  ...
  buildFatigueBar,
}, { getActiveCharacter, setHp } (+13 more)
...
Cohesion: 0.09
Nodes (33): execute(), execute(), { box }, execute(), { formatCommandUsage }, { formatDisplayMention, withMentions }, { formatError }, { getFirstMentionedJid } (+25 more)
...
Nodes (31): { applyFatiguePenalties }, {
  ...
  SIM_HP_MULTIPLIER,
  SIM_STAT_BASE,
}, runSimulation(), simulateBattle() (+23 more)
...
Cohesion: 0.06
Nodes (53): { box }, CATEGORY_DISPLAY, execute(), { formatCommandUsage }, { getOwnerRecords }, { listAdminsForCategory, listAllCategories, getCategoryLabel }, usageMessage, { box } (+45 more)
...
Cohesion: 0.11
Nodes (27): execute(), { formatCharacter }, { getActiveCharacter }, { getInventory }, { logError }, { box }, execute(), { getActiveCharacter } (+19 more)
...
Cohesion: 0.18
Nodes (17): getRecentErrors(), formatDuration(), getMemory(), getUptime(), stats, bar(), cachedErrors, { getRecentErrors } (+9 more)
...
Cohesion: 0.06
Nodes (30): GROUP_ACTIVITY_ROOT, path, hasColumn(), buildDefaultGroupRecord(), { cache, TTLS }, ensureGroupActivity(), { filterExisting }, getGroupActivity() (+22 more)
...
Cohesion: 0.13
Nodes (31): handlePvE(), handlePvECounterAttack(), handlePvP(), { box }, { calcFatigueCost, calcFatigueRecovery, capFatigue }, execute(), { executeReaction, calculateXpReward }, { findSessionByCharacter, advanceTurn, endSession } (+23 more)

### Community 38 - "grupo_cerrar.js"
Cohesion: 0.08
Nodes (44): execute(), { findSessionByUser, removeSession }, { formatCombatDisolved }, execute(), { findSessionByCharacter, findSessionByUser }, { formatCombatStatus }, { formatError }, { getActiveCharacter } (+36 more)
...
Cohesion: 0.13
Nodes (19): { BufferJSON, initAuthCreds }, { logError }, { supabase }, appendToLog(), cleanOldLogs(), ensureLogsDir(), fsp, getErrorsByDate() (+11 more)
...
Cohesion: 0.06
Nodes (44): { addParticipant }, { box }, execute(), { formatError }, { box }, execute(), { formatError }, { openGroup } (+36 more)

### Community 48 - "midnight_review.js"
Cohesion: 0.18
Nodes (16): { getOpenReports, getStats, markStale }, { getOwnerJids }, { logSystem, logError }, midnightReview(), getOpenReports(), getStats(), { logSystem }, markStale() (+8 more)
...
Cohesion: 0.09
Nodes (21): getItemsByCategory(), ITEMS, createEntity(), moduleRegistry, characterLocks, cleanupTemporalItems(), { createItem }, { filterExisting } (+13 more)

### Community 72 - "supabase.js"
Cohesion: 0.22
Nodes (10): applyAttackFatigue(), { box }, { calcFatigueCost, calcFatigueRecovery, capFatigue }, execute(), {
  executeAttack,
  executeReaction,
  chooseAiReaction,
  calculateXpReward,
  ...
  setPendingReaction,
  endSession,
}, { formatActionMenu, formatReactionPrompt, buildFatigueBar }, { formatError } (+2 more)
...
Cohesion: 0.06
Nodes (49): discover(), KNOWN_SCHEMA, { logSystem }, { supabase }, COLUMN_TYPES, createMissingTables(), DESIRED_SCHEMA, detectMissingColumns() (+41 more)
...
Cohesion: 0.09
Nodes (22): { box }, { calculateMovementFatigue, capFatigue, getMovementRange }, { checkAttackRange }, execute(), { findSessionByCharacter, updateDistance }, { formatCommandUsage }, { formatError }, {
  formatMovement,
  formatOutOfRange,
  formatActionMenu,
  buildFatigueBar,
...
Cohesion: 0.08
Nodes (36): { box }, { formatCommandUsage }, { formatError }, { randomInt }, usageMessage, appendHistoriaLine(), { box }, buildCharacterCreatedBox() (+28 more)
...
## Knowledge Gaps
- **648 isolated node(s):** `husky.sh script`, `require`, `sonarjs`, `$schema`, `src/core/bot.js` (+643 more)
...
- **Why does `box()` connect `characterConfig.js` to `bugReportService.js`, `economyAdminHelper.js`, `crear_pj.js`, `box`, `characterProgressionService.js`, `userService.js`, `test_helpers.js`, `groupUtils.js`, `formatErrorUtils.js`, `dar_stelas.js`, `box`, `permissionService.js`, `set_stelas.js`, `dado.js`, `inventario.js`, `formatError`, `grupo_cerrar.js`, `invite.js`, `item_rem.js`, `item_add.js`, `schemaMigration.js`, `supabase.js`, `eco_admin_rem.js`, `dado.js`, `editar_pj.js`?**
  _High betweenness centrality (0.109) - this node is a cross-community bridge._
- **Why does `formatError()` connect `characterConfig.js` to `bugReportService.js`, `economyAdminHelper.js`, `crear_pj.js`, `box`, `characterProgressionService.js`, `userService.js`, `test_helpers.js`, `groupUtils.js`, `formatErrorUtils.js`, `dar_stelas.js`, `set_stelas.js`, `inventario.js`, `formatError`, `grupo_cerrar.js`, `invite.js`, `item_rem.js`, `item_add.js`, `supabase.js`, `eco_admin_rem.js`, `dado.js`, `editar_pj.js`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `supabase` connect `schemaMigration.js` to `bugReportService.js`, `LRUCache`, `economyAdminHelper.js`, `grupo_cerrar.js`, `inventoryService.js`, `actividad.js`, `crear_pj.js`, `getUserProfile`, `economyService.js`, `midnight_review.js`, `permissionService.js`?**
