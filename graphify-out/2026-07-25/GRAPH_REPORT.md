...
Cohesion: 0.19
Nodes (15): { applyFatiguePenalties }, applyPenalties(), attemptBlock(), attemptDodge(), calculateDamage(), canReact(), chooseAiReaction(), { DAMAGE_MIN, BLOCK_REDUCTION } (+7 more)
...
Cohesion: 0.12
Nodes (37): { box }, { calcFatigueCost, calcFatigueRecovery, capFatigue }, execute(), {
  executeAttack,
  executeReaction,
  chooseAiReaction,
  calculateXpReward,
  ...
  setPendingReaction,
  endSession,
}, { formatActionMenu, formatReactionPrompt, buildFatigueBar }, { formatError }, { getActiveCharacter, addXp, setHp } (+29 more)

### Community 38 - "grupo_cerrar.js"
Cohesion: 0.10
Nodes (37): execute(), { findSessionByCharacter, findSessionByUser }, { formatCombatStatus }, { formatError }, { getActiveCharacter }, { createSession, createDummySession, findSessionByCharacter }, { ensureTempTestKit }, execute() (+29 more)
...
Cohesion: 0.16
Nodes (11): execute(), { findSessionByUser, removeSession }, { formatCombatDisolved }, { addXp, setHp }, { advanceTurn, endSession, isSessionActive }, CombatAI, { executeTurn, calculateXpReward }, formatCombatDisolved() (+3 more)
