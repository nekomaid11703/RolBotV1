# Graph Report - RolBotV1  (2026-08-11)

## Corpus Check
- 572 files · ~36,540,692 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4933 nodes · 7383 edges · 262 communities (232 shown, 30 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 340 edges (avg confidence: 0.51)
...
Cohesion: 0.09
Nodes (28): { box }, { createReport }, execute(), reportCooldowns, assertDeclaredImageSize(), CATEGORY_KEYWORDS, createReport(), crypto (+20 more)
...
Cohesion: 0.07
Nodes (68): applyDurabilityHit(), { box }, buildAttackGearLines(), { calcFatigueCost, capFatigue }, execute(), {
  executeAttack,
  executeReaction,
  chooseAiReaction,
  calculateXpReward,
  ...
  setPendingReaction,
  endSession,
}, { formatActionMenu, formatReactionPrompt, buildFatigueBar } (+60 more)

### Community 6 - "crear_pj.js"
Cohesion: 0.15
Nodes (13): { box }, { formatCommandUsage }, { formatDisplayMention }, { formatError }, { formatStelas }, { getFirstMentionedJid, extractAmountFromArgs }, { getUserProfile }, { isSameIdentity } (+5 more)

### Community 7 - "box"
Cohesion: 0.06
Nodes (68): { box }, execute(), { formatCount, formatDate }, { formatDisplayMention, withMentions }, { getFirstMentionedJid }, { getGroupMemberActivity, getGroupActivity }, { getGroupMetadata }, { getUserProfile } (+60 more)
...
Cohesion: 0.08
Nodes (45): { BLOCK_PREFER_DEF_THRESHOLD }, FAMILIES, MATERIAL_RARITY_ORDER, MATERIAL_RARITY_WEIGHTS, TIER_CAPS, {
  ARMOR_SLOTS,
  COVERAGES,
  NO_WEAPON_CHANCE,
  NO_PIECE_CHANCE,
...
Cohesion: 0.11
Nodes (24): buildDefaultProfile(), buildRegistration(), ensureUserProfile(), { filterExisting }, getTopActiveUsers(), listUserProfiles(), METADATA_UPDATERS, normalizeActivity() (+16 more)

### Community 14 - "unwarn.js"
Cohesion: 0.09
Nodes (36): fighterSection(), { generateFighter }, { getSpecialTierMult }, main(), materialLine(), { materialName }, { MATERIALS, getMaterialStats }, parseArgs() (+28 more)
...
Cohesion: 0.10
Nodes (31): { createSession, createDummySession, findSessionByCharacter }, { ensureTempTestKit, ensureIronFamilyKit }, execute(), { formatCombatOpen }, { getActiveCharacter }, { resolveCharacterEquipment }, resolveOpenEquipment(), COMBAT_ACTIONS (+23 more)
...
Cohesion: 0.06
Nodes (53): { addMoney }, execute(), { executeEconomyAction }, { box }, { claimDaily }, { DAILY_COOLDOWN_HOURS }, execute(), formatProgressBar() (+45 more)

### Community 35 - "LRUCache"
Cohesion: 0.10
Nodes (26): TIER_ORDER, allocateStats(), ARCHETYPES, { ARMOR_MODES }, ARMOR_SLOTS, armorConsumption(), attachAmmo(), buildArmorSet() (+18 more)
...
Cohesion: 0.07
Nodes (46): execute(), { findSessionByUser, removeSession }, { formatCombatDisolved }, execute(), { findSessionByCharacter, findSessionByUser }, { formatCombatStatus }, { getActiveCharacter }, { resolveCharacterEquipment } (+38 more)
...
Cohesion: 0.10
Nodes (31): execute(), { formatCharacter }, { getActiveCharacter }, { getInventory }, { logError }, { resolveCharacterEquipment }, logError(), addItem() (+23 more)
...
Cohesion: 0.06
Nodes (38): execute(), { executeGroupAction }, { removeParticipant }, { demoteFromAdmin }, execute(), { executeGroupAction }, { box }, execute() (+30 more)

### Community 74 - "admin_perm_list.js"
Cohesion: 0.07
Nodes (42): { box }, CATEGORY_DISPLAY, execute(), { getOwnerRecords }, { listAdminsForCategory, listAllCategories, getCategoryLabel }, { box }, CATEGORIES, CATEGORY_DISPLAY (+34 more)
...
Cohesion: 0.08
Nodes (21): hasColumn(), cache, TTLS, { cache, TTLS }, cachedRead(), groupCacheKey(), { hasColumn }, invalidateGroupCache() (+13 more)
...
Cohesion: 0.15
Nodes (20): ARMOR_SLOTS, ARROW, COVERAGES, GENERATED_STATS, IRON_FAMILY, ITEM_POOL, MAGIC_STATS, PERSONALITIES (+12 more)
...
Cohesion: 0.13
Nodes (17): ELEMENTS, ModuleBase, SpellModule, buildSpellDefinition(), { createItemDefinition }, crypto, fingerprintSpell(), { getMaterialCost } (+9 more)

### Community 95 - "listCharacters"
Cohesion: 0.12
Nodes (28): getTierPenaltyBonus(), applyArmorMode(), { applyFatiguePenalties }, applyPenalties(), attemptBlock(), attemptDodge(), {
...
Cohesion: 0.15
Nodes (12): 2026-08-03 — Aplicación de DDL: script SQL manual (no RPC `exec_sql`), 2026-08-03 — Capa de sistema gestor de ítems (infraestructura, sin catálogo), 2026-08-03 � Dummy equipado y equipo en memoria (PvE), 2026-08-03 — Familia del Hierro: puente de catálogo, 2026-08-03 — Fuente única de versión de schema, 2026-08-03 — Integración combate: solo ataque principal (backward-compat), 2026-08-03 — Persistencia de equipamiento: columna `equipped_slots`, 2026-08-03 — UI por secciones reutilizables + registro declarativo de acciones de combate (+4 more)
...
Cohesion: 0.28
Nodes (13): allocateDelta(), applyEquipmentBuffs(), capToMaxLevel(), clamp(), clampAll(), generateEquipment(), generateFighter(), generateFighterPair() (+5 more)
...
Cohesion: 0.08
Nodes (38): { getOpenReports, getStats, markStale }, { getOwnerJids }, { logSystem, logError }, midnightReview(), discover(), COLUMN_TYPES, createMissingTables(), { CURRENT_VERSION } (+30 more)

### Community 138 - "composeMessage"
Cohesion: 0.05
Nodes (61): { box }, { formatCommandUsage }, { formatDisplayMention, withMentions }, { formatError }, { getFirstMentionedJid }, { isOwner }, { resolveTargetDisplayName }, { setEconomyAdmin, isEconomyAdmin } (+53 more)
...
Cohesion: 0.11
Nodes (36): applyReactionFatigue(), { BASE_ATTACK_RANGE, KITE_FATIGUE_MULTIPLIER }, {
  calcFatigueRecovery,
  calcFatigueCost,
  capFatigue,
  getFatigueLevel,
  getMovementRange,
}, characterShape(), createDurability(), { executeAttack, executeReaction, chooseAiReaction, getEffectiveWeaponRange }, executeHalfTurn(), fatigueRatio() (+28 more)
...
Cohesion: 0.19
Nodes (18): { box }, execute(), { getOwnerRecords }, { listEconomyAdmins }, { normalizeJid, uniqueStrings }, OWNER_ALIASES, listEconomyAdmins(), extractPhoneNumber() (+10 more)
...
Cohesion: 0.10
Nodes (18): { addParticipant }, { box }, execute(), { box }, { formatCommandUsage }, { formatDisplayMention, withMentions }, { getFirstMentionedJid }, { isOwner } (+10 more)
...
Cohesion: 0.07
Nodes (41): resolveCombatEquipment(), ARMOR_SETS, getSet(), { calculateMovementFatigue }, countSetPieces(), COVERAGE_RULES, getCoverage(), getMovementFatigueWithCoverage() (+33 more)

### Community 226 - "run_phase_c.js"
Cohesion: 0.11
Nodes (25): rollMaterial(), deriveArmorPiece(), allocateStats(), ARCHETYPES, ARMOR_SLOTS, armorConsumption(), attachAmmo(), buildArmorSet() (+17 more)
...
Cohesion: 0.12
Nodes (20): { createItemDefinition }, define(), IRON_ITEMS, IRON_STATS, itemCatalog, itemCatalog, registry, createEntity() (+12 more)
...
Cohesion: 0.29
Nodes (10): { box }, execute(), { findSessionByCharacter }, { getActiveCharacter }, resolveUseTarget(), showInventoryList(), updateSessionHp(), { useItem, getInventoryList } (+2 more)

### Community 257 - "listCharacters"
Cohesion: 0.40
Nodes (5): { box }, execute(), { listCharacters }, listCharacters(), charactersCacheKey()

### Community 259 - "moduleRegistry.js"
Cohesion: 0.33
...
## Knowledge Gaps
- **3270 isolated node(s):** `husky.sh script`, `$schema`, `src/core/bot.js`, `src/commands/**/*.js`, `src/data/**/*.js` (+3265 more)
...
- **Why does `box()` connect `box` to `bugReportService.js`, `listCharacters`, `characterService.js`, `economyAdminHelper.js`, `crear_pj.js`, `composeMessage`, `box`, `resolveTargetDisplayName`, `editar_pj.js`, `dado.js`, `inventario.js`, `moduleRegistry.js`, `grupo_cerrar.js`, `generate_family_report.js`, `item_add.js`, `bugstatus.js`, `inventory_service.test.js`, `admin_perm_list.js`, `getActiveCharacter`, `runSimulation`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `supabase` connect `supabase.js` to `bugReportService.js`, `inventario.js`, `Entity`, `moduleRegistry.js`, `magic_channel.test.js`, `grupo_cerrar.js`, `inventoryService.js`, `columnRegistry.js`, `admin_perm_list.js`, `inventory_service.test.js`, `getUserProfile`, `Plan: Implementacion de Stats Magicas + Correcciones`, `editar_pj.js`, `items.js`, `box`, `durabilityPersistenceService.js`, `listCharacters`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `logError()` connect `inventoryService.js` to `bot.js`, `bugReportService.js`, `inventario.js`, `loggerService.js`, `renombrar_pj.js`, `economyAdminHelper.js`, `grupo_cerrar.js`, `moduleRegistry.js`, `actividad.js`, `columnRegistry.js`, `supabase.js`, `box`?**
