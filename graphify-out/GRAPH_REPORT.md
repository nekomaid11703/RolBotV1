...
## Summary
- 2544 nodes · 4769 edges · 143 communities (114 shown, 29 thin omitted)
...
Cohesion: 0.10
Nodes (23): { box }, execute(), { formatStelas }, { getOrCreateProfile, getUserProfile }, resolveTarget(), { box }, { claimDaily }, { DAILY_COOLDOWN_HOURS } (+15 more)

### Community 5 - "economyAdminHelper.js"
Cohesion: 0.11
Nodes (28): getSpecialTierMult(), getTierPenaltyBonus(), { applyFatiguePenalties }, applyMaterialAbsorption(), applyPenalties(), attemptBlock(), attemptDodge(), calculateDamage() (+20 more)

### Community 6 - "crear_pj.js"
Cohesion: 0.12
Nodes (29): { addMoney }, execute(), { executeEconomyAction }, execute(), { executeEconomyAction }, { removeMoney }, execute(), { executeEconomyAction } (+21 more)

### Community 7 - "box"
Cohesion: 0.08
Nodes (44): { box }, execute(), { formatCount, formatDate }, { formatDisplayMention, withMentions }, { getFirstMentionedJid }, { getGroupMemberActivity, getGroupActivity }, { getGroupMetadata }, { getUserProfile } (+36 more)
...
Cohesion: 0.05
Nodes (73): { aggregate }, aggregate(), getBucket(), initPersonalityMap(), mean(), percentile(), {
  PERSONALITIES,
...
Cohesion: 0.13
Nodes (19): resolveCombatEquipment(), { ARMOR_SETS }, { getCategory }, getEquippedItems(), { getEquippedSlots }, getInventoryWithMetadata(), { getItem }, { getWeaponStats, getArmorStats, getArtifactStats } (+11 more)
...
Cohesion: 0.16
Nodes (8): hasColumn(), { cache, TTLS }, cachedRead(), groupCacheKey(), { hasColumn }, invalidateGroupCache(), safeSelect(), { cachedRead, cache }
...
Cohesion: 0.13
Nodes (28): SESSION_STATES, { buildDummyEquipment }, cleanup(), cloneSession(), createDummySession(), createSession(), expireSession(), getActiveSessionCount() (+20 more)
...
Cohesion: 0.20
Nodes (16): CONTUNDENTE_PERFORANTE_MULT, getTierMultiplier(), normalizeTier(), TIERS, getMaterialStats(), { getTierMultiplier }, MATERIALS, deriveMetadata() (+8 more)
...
Cohesion: 0.07
Nodes (30): { box }, { formatCommandUsage }, { formatDisplayMention, withMentions }, { getFirstMentionedJid }, { isOwner }, { resolveTargetDisplayName }, { setEconomyAdmin }, usageMessage (+22 more)

### Community 77 - "dar_stelas.js"
Cohesion: 0.12
Nodes (15): ARMOR_SETS, getSet(), { createItemDefinition }, IRON_ITEMS, IRON_STATS, itemCatalog, itemCatalog, registry (+7 more)
...
Cohesion: 0.22
Nodes (22): DEFAULT_CHARACTER_SLOTS, filterExisting(), createCharacter(), {
  ...
  xpForNextLevel,
  RANGOS,
}, deleteCharacter(), distribuirPunto(), { filterExisting }, getCharacterSlug() (+14 more)

### Community 84 - "clases.js"
Cohesion: 0.10
Nodes (45): applyAttackFatigue(), applyDurabilityHit(), { box }, buildAttackGearLines(), { calcFatigueCost, capFatigue }, execute(), {
  executeAttack,
  executeReaction,
  chooseAiReaction,
  calculateXpReward,
...
Cohesion: 0.18
Nodes (14): define(), createEntity(), moduleRegistry, buildItem(), { createEntity }, createItemDefinition(), { getMaterialStats }, instantiateEntity() (+6 more)
...
Cohesion: 0.06
Nodes (54): { box }, CATEGORY_DISPLAY, execute(), { getOwnerRecords }, { listAdminsForCategory, listAllCategories, getCategoryLabel }, { box }, CATEGORIES, CATEGORY_DISPLAY (+46 more)
...
Cohesion: 0.20
Nodes (18): applyReactionFatigue(), {
  calcFatigueRecovery,
  calcFatigueCost,
  getFatigueLevel,
  getMovementRange,
}, characterShape(), createDurability(), { executeAttack, executeReaction, chooseAiReaction, checkAttackRange }, executeHalfTurn(), fatigueRatio(), { getCoverage, getMovementFatigueWithCoverage } (+10 more)
...
Cohesion: 0.19
Nodes (17): handlePvPWithReaction(), { box }, buildDivider(), buildDummyAttackLines(), buildKoLines(), buildRestLines(), { calcFatigueRecovery, capFatigue }, execute() (+9 more)
...
Cohesion: 0.15
Nodes (20): execute(), { formatCharacter }, { getActiveCharacter }, { getInventory }, { logError }, { resolveCharacterEquipment }, { createSession, createDummySession, findSessionByCharacter }, { ensureTempTestKit, ensureIronFamilyKit } (+12 more)
...
Cohesion: 0.29
Nodes (8): { logError }, { midnightReview }, scheduleNext(), startMidnightReview(), stopMidnightReview(), { cleanupSock }, { startDashboard, stopDashboard }, { startMidnightReview, stopMidnightReview }

### Community 140 - "huir.js"
Cohesion: 0.29
Nodes (6): { box }, { calcFatigueCost, capFatigue }, {
  findSessionByCharacter,
  endSession,
  advanceTurn,
  setPendingReaction,
...
### Community 142 - "supabaseAuthState.js"
Cohesion: 0.40
Nodes (4): { BufferJSON, initAuthCreds, makeCacheableSignalKeyStore }, { logError }, { supabase }, useSupabaseAuthState()

## Knowledge Gaps
- **1413 isolated node(s):** `husky.sh script`, `$schema`, `src/core/bot.js`, `src/commands/**/*.js`, `src/data/**/*.js` (+1408 more)
...
- **Why does `box()` connect `characterProgressionService.js` to `bugReportService.js`, `characterService.js`, `crear_pj.js`, `box`, `combat_engine.test.js`, `huir.js`, `box`, `resolveTargetDisplayName`, `set_stelas.js`, `dado.js`, `inventario.js`, `invite.js`, `characterConfig.js`, `item_add.js`, `statusService.js`, `dado.js`, `characterConfig.js`, `clases.js`, `eco_admin_list.js`, `getActiveCharacter`, `listCharacters`, `command_format.test.js`, `descansar.js`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `supabase` connect `stryker.config.json` to `bugReportService.js`, `crear_pj.js`, `schemaValidator.js`, `combat_engine.test.js`, `columnRegistry.js`, `getUserProfile`, `supabaseAuthState.js`, `unwarn.js`, `box`, `IA_rolbot — RolBotV1`, `formatError`, `grupo_cerrar.js`, `Plan: Implementacion de Stats Magicas + Correcciones`, `characterConfig.js`, `midnight_review.js`, `inventoryService.js`, `items.js`, `huir.js`, `durabilityPersistenceService.js`, `getActiveCharacter`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `logError()` connect `logError` to `bot.js`, `bugReportService.js`, `loggerService.js`, `renombrar_pj.js`, `crear_pj.js`, `schemaValidator.js`, `actividad.js`, `grupo_cerrar.js`, `combat_engine.test.js`, `inventoryService.js`, `schedulerService.js`, `supabaseAuthState.js`, `midnight_review.js`, `clases.js`, `box`, `huir.js`?**
