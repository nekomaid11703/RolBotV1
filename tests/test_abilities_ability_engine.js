...
function run() {
  ...
  const p = createMockParticipant({ fuerza: 7, precision: 6, fulgor: 50, fatigue: 2, dominio_fulgor: 5, resistencia_fisica: 5, velocidad_ataque: 6 });
  ...
  const pFull = createMockParticipant({
    fuerza: 8, reflejos: 7, velocidad_ataque: 7, precision: 7,
    dominio_fulgor: 6, resistencia_fisica: 6, fulgor: 50, fatigue: 1,
    cooldowns: {},
  });
