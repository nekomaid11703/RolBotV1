...
const combatRefereeService = require('../src/services/rpg/combatRefereeService');
const invService = require('../src/services/rpg/inventoryService');

const helpers = require('./test_helpers');
const { assert, assertEqual, assertDeepEqual, printResults, createMockParticipant, createMockRoom, createMockInventory } = helpers;
...
async function run() {
  ...
  const data1g = { infractions: [{ type: 'mano_blanca', severity: 'alta', description: 'declarar KO' }], mechanics: {} };
