const combatValidator = require('../src/services/rpg/combatValidator');
...
async function run() {
  ...
  assert(combatValidator.validate('no alcanza defender mi golpe.', {}).valid === false, 'no alcanza defender → invalid');
  ...
  assert(combatValidator.validate('le clavo la espada en el pecho.', {}).valid === false, 'clavar espada pecho → invalid');
  assert(combatValidator.validate('le hunde la daga en el cuello.', {}).valid === false, 'hunde daga cuello → invalid');
  assert(combatValidator.validate('le entierra la lanza en el abdomen.', {}).valid === false, 'entierra lanza abdomen → invalid');

  assert(combatValidator.validate('senti que su golpe penetra mi defensa.', {}).valid === false, 'senti que penetra → invalid');
  assert(combatValidator.validate('santi que su ataque impacta en el pecho.', {}).valid === false, 'santi que impacta → invalid');
