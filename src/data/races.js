...
const races = [
  ...
  // =====================================================================
  {
    ...
    passive: {
      name: "Adaptabilidad",
      description:
        "+10% a cualquier stat en situaciones de adaptación. Puede cambiar un bono racial por otro tras un descanso largo.",
    },
    advantages: ["Versatilidad excepcional en cualquier rol", "Capacidad de aprendizaje acelerado con otras razas"],
    disadvantages: ["Sin especialización natural en ningún atributo", "Susceptible a enfermedades y corrupción"],
    relationships: {
      race_elf: "ally",
      race_dwarf: "ally",
      race_goblin: "neutral",
  ...
  // =====================================================================
  {
    ...
    advantages: ["Alta afinidad con la magia arcana y natural", "Sentidos agudizados por siglos de vida"],
    disadvantages: [
  ...
  // =====================================================================
  {
    ...
    advantages: ["Maestría en la forja y artesanía de equipo", "Constitución robusta y alta resistencia física"],
    disadvantages: ["Movimientos lentos y pesados", "Orgullo excesivo que puede llevar a rencillas"],
    relationships: {
      race_human: "ally",
      race_elf: "neutral",
      race_goblin: "enemy",
  ...
  // =====================================================================
  {
    ...
    advantages: ["Alta percepción y reflejos", "Creatividad e ingenio tecnológico"],
    disadvantages: ["Constitución física inferior", "Tendencia a la avaricia y el engaño"],
    relationships: {
      race_human: "neutral",
      race_elf: "neutral",
      race_dwarf: "enemy",
  ...
  // =====================================================================
  {
    ...
    passive: {
      name: "Fuerza bruta",
      description:
        "+15% daño físico. -10% coste de habilidades de fuerza. Puede romper objetos con las manos desnudas.",
    },
    advantages: ["Fuerza física abrumadora", "Resistencia natural al fuego y al dolor"],
    disadvantages: ["Carisma y presencia intimidan a otros", "Impulsividad y dificultad para controlar la ira"],
    relationships: {
      race_human: "enemy",
      race_elf: "enemy",
      race_dwarf: "enemy",
  ...
  // =====================================================================
  {
    ...
    passive: {
      ...
      description:
        "+20% resistencia al elemento de origen. No necesita respirar ni comer. Vulnerabilidad -20% al elemento opuesto.",
    },
    advantages: ["Conexión absoluta con su elemento", "Inmune a necesidades fisiológicas básicas"],
    disadvantages: ["Vulnerabilidad severa al elemento opuesto", "Dificultad para relacionarse con razas mortales"],
    relationships: {
      race_human: "neutral",
      race_elf: "ally",
      race_dwarf: "ally",
  ...
  // =====================================================================
  {
    ...
    passive: {
      name: "Forma híbrida",
      description:
        "Puede alternar entre forma humana y dracónica. +15% todas las stats en forma dracónica. -10% agilidad en forma dracónica.",
    },
    advantages: ["Poder físico y mágico excepcional", "Capacidad de transformación entre formas"],
    disadvantages: [
  ...
  // =====================================================================
  {
    ...
    advantages: ["Alta agilidad y reflejos sobrenaturales", "Magia caótica impredecible pero poderosa"],
    disadvantages: ["Fuerza física inexistente", "Comportamiento errático y poco fiable"],
    relationships: {
      race_human: "neutral",
      race_elf: "ally",
      race_dwarf: "neutral",
  ...
  // =====================================================================
  {
    ...
    advantages: ["Inmunidad a venenos y sangrado", "Alta resistencia física"],
    disadvantages: ["Curación reducida severamente", "Repelente para razas vivas"],
    relationships: {
      race_human: "enemy",
      race_elf: "enemy",
      race_dwarf: "enemy",
  ...
  // =====================================================================
  {
    ...
    advantages: ["Capacidad de drenar vida de los enemigos", "Velocidad y reflejos mejorados en la noche"],
    disadvantages: ["Debilidad severa a la luz solar", "Sed de sangre constante que puede perder el control"],
    relationships: {
      race_human: "enemy",
      race_elf: "enemy",
      race_dwarf: "enemy",
  ...
  // =====================================================================
  {
    ...
    advantages: ["Sentidos agudizados y capacidad de rastreo", "Versatilidad según el tipo de animal"],
    disadvantages: ['Prejuicios de razas "civilizadas"', "Instintos que pueden ser difíciles de controlar"],
    relationships: {
      race_human: "ally",
      race_elf: "ally",
      race_dwarf: "neutral",
  ...
  // =====================================================================
  {
    ...
    passive: {
      ...
      description:
        "Puede reducirse (evasión +30%, daño -30%) o agrandarse (daño +30%, evasión -30%). +20% afinidad con naturaleza.",
    },
    advantages: ["Carisma y presencia mágica inigualables", "Capacidad de cambiar de tamaño tácticamente"],
    disadvantages: ["Fuerza física extremadamente baja", "Vulnerabilidad a la corrupción y la oscuridad"],
    relationships: {
      race_human: "neutral",
      race_elf: "ally",
      race_dwarf: "neutral",
  ...
  // =====================================================================
  {
    ...
    passive: {
      name: "Sobrecarga",
      description:
        "+20% fuerza y defensa por 3 turnos, luego -30% por 2 turnos (enfriamiento). +25% resistencia a estados alterados mentales.",
    },
    advantages: ["Defensa y fuerza excepcionales", "Inmune a estados alterados mentales"],
    disadvantages: ["Carisma y presencia social muy limitados", "Dependencia de mantenimiento y reparaciones"],
    relationships: {
      race_human: "ally",
      race_elf: "neutral",
      race_dwarf: "ally",
  ...
  // =====================================================================
  {
    ...
    passive: {
      name: "Distorsión",
      description:
        "15% de probabilidad de alterar un efecto entrante (daño → cura, buff → debuff, etc). Habilidades de ilusión mejoradas.",
    },
    advantages: ["Capacidad de distorsionar la realidad", "Agilidad y carisma excepcionales"],
    disadvantages: ["Fuerza física por debajo del promedio", "Poco fiables incluso para sus aliados"],
    relationships: {
      race_human: "neutral",
      race_elf: "neutral",
      race_dwarf: "neutral",
  ...
  // =====================================================================
  {
    ...
    passive: {
      name: "Posesión",
      description:
        "Puede controlar cuerpos u objetos inanimados. +20% resistencia a control mental. Vulnerabilidad -20% a luz sacra.",
    },
    advantages: ["Capacidad de posesión y control", "Alta resistencia al control mental"],
    disadvantages: ["Vulnerabilidad severa a luz y magia sacra", "Carisma reducido por su naturaleza espeluznante"],
    relationships: {
      race_human: "enemy",
      race_elf: "enemy",
      race_dwarf: "enemy",
  ...
  // =====================================================================
  {
    ...
    passive: {
      name: "Liberación",
      description:
        "Al llegar a 25% HP o menos, +30% todas las stats por 3 turnos (una vez por combate). La entidad interna puede hablar y aconsejar.",
    },
    advantages: ["Poder latente que se libera en emergencias", "Acceso a conocimiento de la entidad interna"],
    disadvantages: ["Riesgo de que la entidad tome control", "Dependencia de la entidad para su poder máximo"],
    relationships: {
      race_human: "neutral",
      race_elf: "neutral",
      race_dwarf: "neutral",
  ...
  // =====================================================================
  {
    ...
    passive: {
      name: "Corrupción",
      description:
        "Los ataques aplican corrupción (-10% curación, -5% stats por turno). +20% resistencia a vacío. Debilidad -30% a luz y sacro.",
    },
    advantages: ["Capacidad de corromper a los enemigos progresivamente", "Alta resistencia al daño de vacío"],
    disadvantages: ["Debilidad extrema a luz y magia sacra", "Repelente para todas las razas mortales"],
    relationships: {
      race_human: "enemy",
      race_elf: "enemy",
      race_dwarf: "enemy",
  ...
  // =====================================================================
  {
    ...
    passive: {
      name: "Campo sacro",
      description:
        "+15% curación y daño sacro. Los aliados cercanos reciben +5% defensa mágica. +25% resistencia a oscuridad y vacío.",
    },
    advantages: ["Poder sacro que beneficia a todo el grupo", "Alta resistencia a oscuridad y vacío"],
    disadvantages: ["Rigidez moral que limita ciertas acciones", "Vulnerabilidad a la corrupción interna"],
    relationships: {
      race_human: "ally",
      race_elf: "ally",
      race_dwarf: "ally",
  ...
  // =====================================================================
  {
    ...
    passive: {
      ...
      description:
        "Los ataques tienen 20% de probabilidad de ralentizar al objetivo. +20% defensa contra ataques físicos. -10% velocidad.",
    },
    advantages: ["Dominio de la gravedad para control de masas", "Defensa excepcional contra ataques físicos"],
    disadvantages: ["Velocidad de movimiento reducida", "Carisma bajo por su naturaleza alienígena"],
    relationships: {
      race_human: "neutral",
      race_elf: "neutral",
      race_dwarf: "neutral",
  ...
  // =====================================================================
  {
    ...
    passive: {
      ...
      description:
        "+30% stats en agua. Puede respirar bajo el agua. +15% velocidad de natación. -15% en desiertos o zonas áridas.",
    },
    advantages: ["Poder absoluto en entornos acuáticos", "Canto hipnótico y carisma natural"],
    disadvantages: ["Rendimiento reducido en zonas secas", "Dependencia del agua para mantener su poder"],
    relationships: {
      race_human: "neutral",
      race_elf: "ally",
      race_dwarf: "neutral",
  ...
  // =====================================================================
  {
    ...
    passive: {
      name: "Campo corrupto",
      description:
        "Los enemigos cercanos reciben -10% defensa. +20% daño de oscuridad y fuego. -15% resistencia a luz y sacro.",
    },
    advantages: ["Poder corruptor que debilita a los enemigos", "Alto daño de oscuridad y fuego"],
    disadvantages: ["Vulnerabilidad a luz y magia sacra", "Desconfianza innata de todas las demás razas"],
    relationships: {
      race_human: "enemy",
      race_elf: "enemy",
      race_dwarf: "enemy",
