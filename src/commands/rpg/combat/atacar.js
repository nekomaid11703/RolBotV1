...
const { executeAttack, executeReaction, chooseAiReaction } = require("../../../services/rpg/combatEngine");
const { formatActionMenu, formatReactionPrompt } = require("../../../services/rpg/combatMessages");
  ...
  async execute(ctx) {
    ...
    if (session.isPvE) {
      ...
      if (reactionResult.ko) {
        ...
        lines.push(`🏆  ¡*${attackerSlot.character.name}* gana el combate!`);
