...
module.exports = {
  ...
  async execute(ctx) {
    ...
    if (playerSlot.prison && playerSlot.prison.hp > 0) {
      return ctx.reply(
        `❌ *${activeChar.name}* está atrapado en una **Prisión Mágica** [🛡️ ${playerSlot.prison.hp}/${playerSlot.prison.maxHp} HP]. Debes atacarla para destruirla antes de poder retroceder.`,
      );
    }
