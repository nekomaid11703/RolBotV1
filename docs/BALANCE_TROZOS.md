...
| B6 | Hitos de equipo y poder por rango | Implementado; sets por material y poder por cohorte (2026-09-09) |
...
- **B6**: poder relativo por build y cohorte en el reporte (`buildBuildPowerReport`); ≥3 estilos
  viables por cohorte (P5) medidos con score normalizado por eje; sets por material con bono de
  arquetipo. Verificado: mínimo 3 estilos viables en todas las cohortes.
